...
const Footer = () => {
    return (
        <footer id="footer" className="bg-white order-last border-t">
                ...
                <div className="flex flex-wrap justify-start gap-8 lg:gap-20">
                    <div className="w-auto">
                            ...
                            <div className="text-sm text-gray-700">
                                <Link href="#" className="py-1.5 block">About Us</Link>
                                <Link href="#" className="py-1.5 block">Product</Link>
                    ...
                    <div className="w-auto">
                        ...
                        <div className="text-sm text-gray-700">
                            ...
                            <h2 className="py-1.5 block">info@digigate.id</h2>
                        </div>
                    </div>
                    <div className="w-auto">
                            <div className="mb-1 font-semibold font-sans text-black">Address</div>
                            <div className="text-sm text-gray-700">
                                <Link href="#" className="py-1.5 flex">
            ...
            <div className="container mx-auto border-t flex items-center justify-between p-4">
                ...
                <p className="text-[10px] md:text-sm text-gray-600">Copyright © 2024 DigiGate All rights reserved.</p>
            </div>
        </footer>
    );
}
