                    ...
                    <div className="w-auto">
                        ...
                        <div className="text-sm text-gray-700">
                            <h2 className="py-1.5 block">
                                ...
                                <Link href={`mailto:${email}`} dangerouslySetInnerHTML={{ __html: obfuscatedEmail }}></Link>
                            </h2>
                        </div>
                    </div>
                    <div className="w-auto">
                            ...
                            <div className="text-sm text-gray-700">
                                ...
                                <Link href={`mailto:${email}`} className="py-1.5 flex" >
                                    ...
                                    {/* Email */}
                                    <p dangerouslySetInnerHTML={{ __html: obfuscatedEmail }}></p>
                                </Link>
